...
(function () {
    ...
    fetch(localStorage.getItem("stamp_database") ?? "https://github.com/CMcGraw77777/Neoclassic/blob/4302befbf7e9105ff1dc533f5dc73f48608632b4/neostamp", { cache: "no-cache" })
        .then(res => res.json())
        .then(main)
